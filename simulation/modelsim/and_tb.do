...
add wave -noupdate /DataPath_tb/DUT/bus/BusMuxInR4
add wave -noupdate /DataPath_tb/DUT/bus/BusMuxInR7
...
add wave -noupdate /DataPath_tb/DUT/alu/and_out
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {132185 ps} 0}
