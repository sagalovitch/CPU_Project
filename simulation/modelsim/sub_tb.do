...
add wave -noupdate -radix hexadecimal /DataPath_tb/DUT/bus/BusMuxInR7
...
add wave -noupdate /DataPath_tb/DUT/alu/sub_out
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {152734 ps} 0}
